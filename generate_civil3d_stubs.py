...
def get_method_docstring(method):
    ...
    for p in soup.select("#parameters dl"):
        ...
        parameters.append({"name": p_name, "type": p_type, "description": p_description})
    ...
    if constructor["children"]:
        for constructor_overload in constructor["children"]:
            ...
            if parameters:
                ...
                parameters = ""
            constructor_docstring.append("{}({})".format(name.strip(), parameters))
    else:
